...
def scraping():
    ...
    MONEYLINE_EXTENSION = 'money-line/1st-half/'
    TOTALS_EXTENSION = 'totals/1st-half/'
    DATE_EXTENSION = '?date=20210906'
    ...
    spread_data = requests.get(
        ADDRESS + '1st-half/' + DATE_EXTENSION,
        headers=headers
    )
...
# Create dictionary of odds for each game
    ...
    with open('./sportsbook/src/data/ncaaFBhalf.json', 'w') as data:
        json.dump(ODDS, data)
